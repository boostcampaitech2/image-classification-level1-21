...
if __name__ == '__main__':
    ...
    print(ModelList.parse_model(model_name)(xdim=[3,512,384], ksize=3, cdims=[], hdims=[256], ydim=18))
    ...
    model = ModelList.parse_model(model_name)(xdim=[3,512,384], ksize=3, cdims=[], hdims=[256], ydim=18).to(device)
    print(model)
    #model.init_param()
